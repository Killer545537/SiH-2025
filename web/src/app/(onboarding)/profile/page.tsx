...
const ProfilePage = () => {
  ...
  const availableSkills = [
    ...
    'SQL', 'Machine Learning', 'AI', 'Cloud Computing', 'DevOps',
    'Customer Service', 'Sales', 'Finance', 'Accounting', 'Research',
    'Problem Solving', 'Team Work', 'Time Management', 'Public Speaking'
  ];
  ...
  const updateLanguage = (id: string, field: keyof Language, value: string) => {
    setSkillsData({
      ...skillsData,
      languages: skillsData.languages.map(lang =>
  ...
  const handleFileUpload = async (file: File, educationId: string) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        updateEducation(educationId, 'marksValue', `${educations.find(e => e.id === educationId)?.marksValue} (Certificate: ${result.fileName})`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <Link href="/ekyc" className="inline-flex items-center text-primary hover:text-primary/80 mb-4">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Your basic information (auto-filled from eKYC)</CardDescription>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    {errors['personal.fatherName'] && (
                      <p className="text-xs text-destructive">{errors['personal.fatherName']}</p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setPersonalData({ ...personalData, category: value as any })}
                    >
                      <SelectTrigger className={errors['personal.category'] ? 'border-destructive' : ''}>
                    ...
                    {errors['personal.category'] && (
                      <p className="text-xs text-destructive">{errors['personal.category']}</p>
                    )}
                  </div>
                </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, line1: e.target.value },
                          })
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, line2: e.target.value },
                          })
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, state: e.target.value },
                          })
                        }
                        placeholder="State"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, district: e.target.value },
                          })
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, block: e.target.value },
                          })
                        }
                        placeholder="Block"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, village: e.target.value },
                          })
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            permanentAddress: { ...personalData.permanentAddress, pin: e.target.value },
                          })
                        }
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setPersonalData({
                          ...personalData,
                          currentAddress: { ...personalData.currentAddress, sameAsPermanent: checked as boolean },
                        })
                      }
                    />
                    <Label htmlFor="sameAddress">Current address is same as permanent address</Label>
                  </div>
                </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setPersonalData({
                            ...personalData,
                            disability: { ...personalData.disability, hasDisability: checked as boolean },
                          })
                        }
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPersonalData({
                            ...personalData,
                            disability: { ...personalData.disability, type: e.target.value },
                          })
                        }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Auto-filled from registration</p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setContactData({ ...contactData, alternateMobile: e.target.value })}
                ...
                <div className="space-y-2">
                  ...
                  {errors['contact.email'] && <p className="text-xs text-destructive">{errors['contact.email']}</p>}
                  {contactData.emailVerified && <p className="text-xs text-green-600">Email verified successfully</p>}
                </div>
                ...
                {otpSent && !contactData.emailVerified && (
                  <div className="space-y-2">
                    ...
                    {errors['contact.otp'] && <p className="text-xs text-destructive">{errors['contact.otp']}</p>}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateEducation(education.id, "subject", e.target.value)}
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateEducation(education.id, "board", e.target.value)}
                          ...
                          <div className="space-y-2">
                            ...
                            <Select
                              ...
                              onValueChange={(value) => updateEducation(education.id, "marksType", value)}
                            >
                              <SelectTrigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateEducation(education.id, "marksValue", e.target.value)}
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setBankData({ ...bankData, isAadhaarSeeded: checked as boolean })}
                  />
                  <Label htmlFor="aadhaarSeeded">Is your bank account Aadhaar-seeded and NPCI-linked?</Label>
                </div>
                ...
                <CardContent className="space-y-4">
                  {skillsData.languages.length === 0 ? (
                    ...
                    skillsData.languages.map((language) => (
                      <div key={language.id} className="flex items-center gap-4 p-4 border rounded-lg">
